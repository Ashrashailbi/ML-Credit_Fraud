...
def load_fraud_model():
    return joblib.load("Credit_Card_Fraud_Detection.pkl")

try:
    model = load_fraud_model()
except Exception as e:
    st.error("Model file 'Credit_Card_Fraud_Detection.pkl' not found. Please ensure it is in the same directory.")
    st.stop()
